...
//     expect($route.routes['/graph'].templateUrl).to.be('app/shared/graph.view.html');
//   });
...
//     expect($route.routes['/profile'].templateUrl).to.be('app/shared/profile.view.html');
//   });
...
//     expect($route.routes['/viewPost'].templateUrl).to.be('app/shared/view.post.view.html');
//   });
...
//     expect($route.routes['/newPost'].templateUrl).to.be('app/shared/write.new.post.view.html');
//   });
...
//     expect($route.routes['/home'].templateUrl).to.be('app/shared/home.view.html');
//   });
// });
