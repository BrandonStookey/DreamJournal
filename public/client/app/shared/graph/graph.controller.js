...
function liquidFillGaugeDefaultSettings(){
    ...
    dream.waveAnimateTime = 2000;
    dream.waveHeight = 0.3;
    dream.waveCount = 1

    var dreamGauge = loadLiquidFillGauge("dreamersGauge", 45, dream);
    ...
    nightmare.waveAnimateTime = 2000;
    nightmare.waveHeight = 0.3;
    nightmare.waveCount = 1;    

    var nightmareGauge = loadLiquidFillGauge("nigthmarersGauger", 55, nightmare);
